...
t1 <- system.time(jagsgen <- lapply(jagsfilenames,geni))
print(t1)
print(jagsgen[[1]])

saveRDS(jagsgen,file=paste("./jags_dir/results/gen_",targetname[2],"_",targetname[3],".RDS",sep=""))
